          ...
          <div className="flex flex-col items-center md:items-start">
            ...
            <div className="flex flex-col gap-3 font-body text-gray-400 text-sm">
              <div className="flex items-start gap-4">
                ...
                <span className="text-right md:text-left">FC Road, Pune</span>
              </div>
              <div className="flex items-start gap-4">
                <span className="text-[#DAA520] font-bold">Phone:</span>
                <span>+91 84466 53644</span>
              </div>
              <div className="mt-4 text-xs italic">
                Need help or have a question?
              </div>
              <div>
                Contact us at: <a href="mailto:futoragroup@gmail.com" className="text-white hover:underline">futoragroup@gmail.com</a>
              </div>
            </div>
          </div>
        </div>
